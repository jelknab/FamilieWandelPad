...
{
    public class AnimatedNavigatorRot : INavigator
    {
        ...
        public AnimatedNavigatorRot(Mapsui.Map map, IViewport viewport)
        {
            _map = map;
            _viewport = viewport;
        }
        ...
        public void NavigateTo(Point center, double resolution, double rotation = 0, long duration = 300)
        {
